<template>
  <div class="review-wrapper">
    ...
    <scroll class="review-detail" :data="reviewDetail">
      ...
      <load-more :fullShow="fullShow" v-if="!reviewDetail.author"></load-more>
    </scroll>
  </div>
</template>
...
<script type="text/ecmascript-6">
  ...
  import { getDiscussDetail } from 'api/movie-detail'
  ...
  export default{
    ...
    created() {
      this._getDetail(this.currentReviewId)
    },
    computed: {
      ...mapGetters(['currentReviewId'])
    },
    methods: {
      back() {
        this.$router.back()
